...
IF(${PLUSBUILD_USE_libwebm} AND ${PLUS_ENABLE_VIDEOSTREAMING} AND ${PLUSBUILD_USE_OpenIGTLink})
  LIST(APPEND PLUSBUILD_ADDITIONAL_SDK_ARGS
      -Dlibwebm_INCLUDE_DIR:PATH=${PLUS_LIBWEBM_SRC_DIR}
      -Dlibwebm_BINARY_DIR:PATH=${PLUS_LIBWEBM_DIR}
      )
ENDIF()
...
ExternalProject_Add(PlusLib
  ...
  CMAKE_ARGS
    ...
    -DPLUS_USE_libwebm:BOOL=${PLUSBUILD_USE_libwebm}
