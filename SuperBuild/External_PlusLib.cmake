...
IF(PLUS_USE_TOBII_INTERACTION)
  LIST(APPEND PLUSBUILD_ADDITIONAL_SDK_ARGS
    -DTobiiInteractionSDK_INCLUDE_DIR:PATH=${TobiiInteractionSDK_INCLUDE_DIR}
    -DTobiiInteractionSDK_BINARY_DIR:PATH=${TobiiInteractionSDK_BINARY_DIR}
    -DTobiiInteractionSDK_LIBRARIES=${TobiiInteractionSDK_LIBRARIES}
    )
ENDIF()
...
ExternalProject_Add(PlusLib
  ...
  CMAKE_ARGS
    ...
    -DPLUS_USE_TOBII_INTERACTION:BOOL=${PLUS_USE_TOBII_INTERACTION}
