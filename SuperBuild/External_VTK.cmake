if(VTK_DIR)
  ...
  if(QT_FOUND)
    if(PLUSBUILD_VTK_VERSION VERSION_LESS 9.0.0)
      ...
      list(APPEND _vtk_options -DVTK_Group_Qt:BOOL=ON -DVTK_QT_VERSION:STRING=${QT_VERSION_MAJOR})
    else()
      list(APPEND _vtk_options -DVTK_GROUP_ENABLE_Qt:STRING=YES -DVTK_QT_VERSION:STRING=${QT_VERSION_MAJOR})
    endif()
  endif()
